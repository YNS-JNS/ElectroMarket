...
function ProductFilterAside() {
    return (
        <div className="w-[18rem]">
            <p className="text-lg font-medium text-gray-700">Filters</p>
            ...
            <div className="mt-1 flex flex-col gap-4">
                    ...
                    <div className="border-t border-gray-200">
                        ...
                        <div className="border-t border-gray-200 p-4 flex flex-col gap-2">
                            {availability.map((av, idx) => (
                                <label key={idx} htmlFor={`av_${idx}`} className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        id={`av_${idx}`}
                                    ...
                                    <span className="text-sm font-medium text-gray-700">{av}</span>
                                </label>
                            ))}
                        </div>
                    </div>
                            ...
                            <div className="flex justify-between gap-4">
                                <label htmlFor="FilterPriceFrom" className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        id="FilterPriceFrom"
                                        placeholder="From"
                                        className="input input-bordered rounded-lg input-sm w-full bg-white"
                                    />
                                </label>
                ...
                <details className="overflow-hidden rounded-lg border border-gray-300 bg-white" open>
                    ...
                    <div className="border-t border-gray-200">
                        ...
                        <div className="border-t border-gray-200 p-4 flex flex-col gap-2">
                            {colors.map((col, idx) => (
                                <label key={idx} htmlFor={`col_${idx}`} className="flex items-center gap-2">
                                    <input
                                        type="checkbox"
                                        id={`col_${idx}`}
                                        className="checkbox checkbox-sm checkbox-primary border-gray-400"
